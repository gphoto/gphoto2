...
main (int argc, char **argv, char **envp)
{
	...
	const struct poptOption captureOptions[] = {
		...
		{"wait-event", '\0', POPT_ARG_STRING|POPT_ARGFLAG_OPTIONAL, NULL, ARG_WAIT_EVENT,
		 N_("Wait for event(s) from camera"), N_("COUNT, or SECONDS, or MATCHSTRING")},
		{"wait-event-and-download", '\0', POPT_ARG_STRING|POPT_ARGFLAG_OPTIONAL, NULL,
		 ARG_CAPTURE_TETHERED, N_("Wait for event(s) from the camera and download new images"), N_("COUNT, or SECONDS, or MATCHSTRING")},
		...
		{"capture-tethered", '\0', POPT_ARG_STRING|POPT_ARGFLAG_OPTIONAL, NULL,
		 ARG_CAPTURE_TETHERED, N_("Wait for shutter release on the camera and download"), N_("COUNT, SECONDS or MATCHSTRING")},
		{"trigger-capture", '\0', POPT_ARG_NONE, NULL,
